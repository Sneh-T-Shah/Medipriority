...
def get_user_input():
    general_information = """
    general_information = "Patient Name: Sneh Age: 70 Symptoms: - Low fever (99 degrees Fahrenheit) - Cold - Cough Pain Assessment:  None provided Medication: Paracetamol, effective for a few hours Symptom Duration: 2 days Additional Information: None"
    """
    visual_information = """
